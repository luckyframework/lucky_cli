  ...
  it "creates a full web app without auth" do
    ...
    with_project_cleanup do
      ...
      FileUtils.cd "test-project" do
        ...
        should_run_successfully "crystal run tasks.cr -- gen.action.api Api::Users::Show"
        should_run_successfully "crystal run tasks.cr -- gen.action.browser Users::Show"
        should_run_successfully "crystal run tasks.cr -- gen.migration CreateThings"
        should_run_successfully "crystal run tasks.cr -- gen.model User"
        should_run_successfully "crystal run tasks.cr -- gen.page Users::IndexPage"
        should_run_successfully "crystal run tasks.cr -- gen.component Users::Header"
        should_run_successfully "crystal run tasks.cr -- gen.resource.browser Comment title:String"
        should_run_successfully "crystal run tasks.cr -- gen.task email.monthly_update"
        should_run_successfully "crystal run tasks.cr -- gen.secret_key"
